...
**
** Created: Wed Sep 12 00:33:57 2012
...
static const char qt_meta_stringdata_SvCreator[] = {
    ...
    "open()\0save()\0saveAs()\0int\0close(bool)\0"
    "close()\0fillEditorFromService(QTreeWidgetItem*)\0"
...
int SvCreator::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: save(); break;
        case 6: saveAs(); break;
        case 7: { int _r = close((*reinterpret_cast< const bool(*)>(_a[1])));

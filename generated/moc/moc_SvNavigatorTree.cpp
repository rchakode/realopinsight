...
#include "../../client/src/SvNavigatorTree.hpp"
...
void SvNavigatorTree::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        SvNavigatorTree *_t = static_cast<SvNavigatorTree *>(_o);
        switch (_id) {
        case 0: _t->treeNodeMoved((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData SvNavigatorTree::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SvNavigatorTree::staticMetaObject = {
    { &QTreeWidget::staticMetaObject, qt_meta_stringdata_SvNavigatorTree,
      qt_meta_data_SvNavigatorTree, &staticMetaObjectExtraData }
};

...
[Files]
Source: "E:\Dev\qt-build\release\realopinsight-manager.exe" ; DestDir: "{app}"      
Source: "E:\Dev\qt-build\release\realopinsight-oc.exe" ; DestDir: "{app}"  
Source: "E:\Dev\qt-build\release\realopinsight-editor.exe" ; DestDir: "{app}"
...
Source: "C:\Qt\5.5\mingw492_32\bin\Qt5Network.dll" ; DestDir: "{app}"
Source: "C:\Qt\5.5\mingw492_32\bin\Qt5Script.dll" ; DestDir: "{app}"
Source: "C:\Qt\5.5\mingw492_32\bin\Qt5WebKit.dll" ; DestDir: "{app}"
Source: "C:\Qt\5.5\mingw492_32\bin\Qt5WebKitWidgets.dll" ; DestDir: "{app}"
Source: "C:\Qt\5.5\mingw492_32\bin\Qt5Widgets.dll" ; DestDir: "{app}"
Source: "C:\Qt\5.5\mingw492_32\bin\Qt5Xml.dll" ; DestDir: "{app}"
Source: "C:\Qt\5.5\mingw492_32\bin\icuin*.dll" ; DestDir: "{app}"
Source: "C:\Qt\5.5\mingw492_32\bin\icuuc*.dll" ; DestDir: "{app}"
Source: "C:\Qt\5.5\mingw492_32\bin\icudt*.dll" ; DestDir: "{app}"
Source: "C:\Qt\5.5\mingw492_32\bin\Qt5Sql.dll" ; DestDir: "{app}"
Source: "C:\Qt\5.5\mingw492_32\bin\Qt5Qml.dll" ; DestDir: "{app}"
Source: "C:\Qt\5.5\mingw492_32\bin\Qt5Quick.dll" ; DestDir: "{app}"
Source: "C:\Qt\5.5\mingw492_32\bin\Qt5Positioning.dll" ; DestDir: "{app}"
Source: "C:\Qt\5.5\mingw492_32\bin\Qt5Multimedia.dll" ; DestDir: "{app}"
Source: "C:\Qt\5.5\mingw492_32\bin\Qt5Sensors.dll" ; DestDir: "{app}"
Source: "C:\Qt\5.5\mingw492_32\bin\Qt5OpenGL.dll" ; DestDir: "{app}"
Source: "C:\Qt\5.5\mingw492_32\bin\Qt5PrintSupport.dll" ; DestDir: "{app}"
Source: "C:\Qt\5.5\mingw492_32\bin\Qt5MultimediaWidgets.dll" ; DestDir: "{app}"
Source: "C:\Qt\5.5\mingw492_32\bin\Qt5Svg.dll" ; DestDir: "{app}"                
Source: "C:\Qt\5.5\mingw492_32\bin\Qt5WebChannel.dll" ; DestDir: "{app}"                    
...
Source: "E:\Dev\ZeroMQ-2.2.0\bin\libzmq-v100-mt.dll" ; DestDir: "{app}"   
Source: "E:\Dev\ZeroMQ-2.2.0\bin\msvcp100.dll" ; DestDir: "{app}"

Source: "C:\Qt\5.5\mingw492_32\bin\libstdc++-6.dll" ; DestDir: "{app}"    
Source: "C:\Qt\5.5\mingw492_32\bin\libwinpthread-1.dll" ; DestDir: "{app}"
                                           
Source: E:\Dev\qt-build\release\*  ; DestDir: "{app}" 

...
void GuiPreferences::fillFromSource(int _index)
{
...
void GuiPreferences::saveAsSource(const qint32& index, const QString& type)
{
  ...
  setEntry(Settings::GLOBAL_LANGUAGE_KEY, m_languageBoxField->itemData(m_languageBoxField->currentIndex()).toString());
